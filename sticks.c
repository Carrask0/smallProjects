...
void init(void)
{
    ...
    printf("-THE WAY YOU INTRODUCE A MOVE IS BY INPUTTING TWO NUMBERS TOGETHER, THE FIRST NUMBER BEING THE COLUMN YOU TAKE THE NUMBER FROM AND THE SECOND NUMBER BEING THE COLUMN YOU PUT THE NUMBER INTO\n");
    changeColor("def");
}
